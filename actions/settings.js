...
export const getDealershipInfo = async () => {
    try {
        ...
        throw new Error("Error featching dealership info", error.message);
    }
}
...
export const saveWorkingHours = async (workingHours) => {
    try {
        ...
        throw new Error("Error updating working hours", + error.message);
    }
}
...
export const getUsers = async () => {
    try {
        ...
        throw new Error("Error featching users:", + error.message);
    }
}
