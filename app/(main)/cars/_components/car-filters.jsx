...
import CarFilterControls from './filters-controle';
import {
    Select,
    SelectContent,
    SelectItem,
                ...
                <div className='flex items-center'>
                    <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
                        <SheetTrigger asChild>
                            <Button variant="outlline" className="flex items-center gap-2">
                        ...
                        <SheetContent side='left' className="w-full sm:max-w-md overflow-y-auto">
                            ...
                            <SheetFooter className="sm:justify-between flex flex-row pt-2 border-t space-x-4 mt-auto">
